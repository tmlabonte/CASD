...
src_base = os.path.join("/mnt/cvgroupsouthcentral", "fsod", "annotations")
dst_base = os.path.join("/mnt/cvgroupsouthcentral", "fsod", "annotations", "voc2")
...
sets = {
    "trainval": os.path.join(src_base, "fsod_200_train_seed2_trn0.8.json"),
    "test": os.path.join(src_base, "fsod_200_test_seed2_trn0.8.json"),
}
